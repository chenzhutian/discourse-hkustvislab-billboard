...
export default {
  ...
  initialize(container) {
    console.debug('start-whos-online#init');
    ...
    console.debug('online-service#', onlineService);
    ...
    withPluginApi('0.2', api => {
      ...
      api.modifyClass('route:user', {
        ...
        updateBodyClass: async function () {
          // this.store.find('user').then(res => {
          //   console.debug('startingData', res);
          // });
          // console.debug('adf', this.modelFor.toString());
